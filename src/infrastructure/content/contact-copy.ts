...
export const contactAlternativesCopy = {
    ...
    headingBadge: 'Tu préfères autre chose que Calendly ?',
    headingTitle: 'Alternatives rapides',
    expressFormTitle: 'Formulaire express',
    expressFormNamePlaceholder: 'Ton prénom',
    expressFormEmailPlaceholder: 'Ton email',
    expressFormMessagePlaceholder: 'Ton message (3 lignes suffisent)',
    expressFormConsentLabel: 'J’accepte que mes informations soient utilisées pour être recontacté·e au sujet de ma demande.',
    expressFormSubmitLabel: 'Envoyer',
    expressFormSendingLabel: 'Envoi…',
    expressFormErrorEmailCta: 'Écris-moi par email',
    emailCardTitle: 'Écrire un email',
    emailCardDescription: 'Décris-moi en 3–5 lignes ton besoin, je te réponds sous 24–48h ouvrées.',
    emailCopyButtonLabel: 'Copier',
    emailCopyButtonAriaLabel: 'Copier l’adresse e-mail',
    messagingCardTitle: 'Messagerie',
    messagingCardDescription: 'Tu préfères écrire vite fait par messagerie ? Pas de souci.',
    linkedinButtonLabel: 'LinkedIn',
    whatsappButtonLabel: 'WhatsApp',
    messagingMissingConfigPrefix: 'Configure',
    messagingMissingConfigMiddle: 'et/ou',
    messagingMissingConfigSuffix: 'pour afficher les boutons.',
    successModalCloseAriaLabel: 'Fermer la fenêtre',
    successModalTitle: 'Message envoyé',
    successModalDescription: 'Merci ! Je te réponds sous 24–48h ouvrées. Tu peux aussi réserver un créneau dans l’agenda si tu préfères.',
    successModalScheduleLabel: 'Réserver un appel',
    successModalCloseLabel: 'Fermer',
