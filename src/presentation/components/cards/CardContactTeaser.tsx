...
export default function ContactTeaserCard() {
    return (
        <Link
            href="/contact"
            className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-sauge/30 bg-background/70 shadow-sm transition-all hover:-translate-y-1.5 hover:shadow-md"
        >
            <div className="relative aspect-16/10">
                <div className="absolute inset-0 bg-linear-to-br from-terracotta/20 via-ormat/10 to-sauge/10" />
                <div className="absolute inset-0 opacity-20 bg-[radial-gradient(currentColor_1px,transparent_1px)] bg-size[16px_16px] text-ormat" />
            ...
            <div className="pointer-events-none absolute left-4 right-4 bottom-4 h-0.5 overflow-hidden">
