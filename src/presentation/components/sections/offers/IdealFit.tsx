    ...
    const items = [
        {
            ...
            bullets: ['Ton & visuels apaisants', 'Infos pratiques lisibles', 'Réservation (Calendly/Cal.com)'],
        ...
        },
        {
            ...
            objective: { icon: Images, label: 'Objectif : Portfolio' },
        },
        {
            icon: Briefcase,
            ...
            objective: { icon: Target, label: 'Objectif : Leads doux' },
        },
    ] as const;

    return (
        <section id="audience" aria-labelledby="audience-title" className="relative py-16 md:py-28 px-6 md:px-8 lg:px-[100px] xl:px-[150px]">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 items-stretch">
                    {items.map(({ icon: Icon, title, desc, bullets, objective }) => (
                        ...
                        >
                            ...
                            {/* Footer — chip objectif en bas de la carte */}
