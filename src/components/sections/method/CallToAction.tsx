    ...
    return (
        <section className="relative py-16 md:py-28 px-6 md:px-8 lg:px-[100px] xl:px-[150px] bg-background">
            ...
            <div className="relative max-w-5xl mx-auto text-center space-y-8">
                ...
                {/* Titre */}
                <h2 className="text-terracotta font-title text-3xl md:text-4xl font-bold tracking-widest leading-tight">Créons ensemble le site qui fera rayonner ton univers</h2>

                {/* Texte */}
                <p className="text-base md:text-lg text-foreground/80 leading-relaxed max-w-2xl mx-auto">
                    Ton projet mérite plus qu’un simple site web. Il mérite une présence en ligne alignée à ton essence, qui attire les bonnes personnes et travaille pour toi.
                    Parlons-en dès maintenant et voyons comment lui donner vie.
                </p>
