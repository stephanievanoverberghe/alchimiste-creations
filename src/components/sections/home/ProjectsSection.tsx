...
import CardContactTeaser from '../../cards/CardContactTeaser';
...
export default function ProjectsSection({ projects, ctaHref = '/projets' }: { projects?: Project[]; ctaHref?: string }) {
    ...
    // Tri par "derniers en date" (year desc), fallback: ceux sans year vont à la fin
    const sortedByYearDesc = [...source].sort((a, b) => {
        ...
        // petit tie-breaker stable: wip d'abord, sinon ordre alpha
    ...
    // On affiche 2 projets les plus récents, puis le teaser contact en dernier
        ...
        <section className="relative py-16 md:py-28 px-6 md:px-8 lg:px-[100px] xl:px-[150px]">
            ...
            <div className="relative mx-auto w-full max-w-7xl">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-stretch">
                    ...
                    {/* La dernière tuile est toujours un teaser contact */}
                    <li className="h-full">
                        <CardContactTeaser />
                    </li>
                </ul>
