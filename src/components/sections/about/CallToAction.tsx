...
export default function CallToActionSection({ note = 'Réponse sous 24–48h ouvrées.' }: { note?: string }) {
    return (
        <section id="cta-contact" aria-labelledby="cta-contact-title" className="relative py-16 md:py-28 px-6 md:px-8 lg:px-[100px] xl:px-[150px]">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 md:gap-6 relative z-[1]">
                        <div>
                            <span className="inline-flex items-center gap-2 text-xs tracking-[0.25em] uppercase text-terracotta bg-terracotta/10 border border-terracotta/30 rounded-full px-4 py-1">
                                ...
                                <span>Appel découverte · 30 min</span>
                            </span>
                            ...
                            <p className="mt-3 text-base md:text-lg text-foreground/80 max-w-2xl">On clarifie besoin, budget et délais — sans jargon, sans pression.</p>
                        </div>
